                    ...
                    <Carousel autoplay loop style="margin-right:30px;">
                        <CarouselItem v-for="item in carousel" style="height:300px;">
                            <div class="demo-carousel">
                                <img :src="$_global_$.imgPath + item.imageUrl" style="width: 100%;height: 300px">
                            </div>
                        </CarouselItem>
                    </Carousel>
                </Col>
        ...
        <div v-show="$_onlineBooking_$">
            ...
            <Row>
                <Col span="12" style="font-size:14px;" class="sz">
                    ...
                    &nbsp;&nbsp;选择日期:
                    <DatePicker @on-change="$_qh_$" type="date" :editable="false" placeholder="请选择日期" style="width: 150px"></DatePicker>
                </Col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            $_tc_$() {
                this.$root.$_Route_$("superadmin", "sssManage", "assembManage", {zoneId: this.row.zoneId});
            },
            $_formatNum_$(str) {
                var newStr = "";
                var count = 0;
