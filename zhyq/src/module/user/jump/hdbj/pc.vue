    ...
    export default {
        ...
        methods: {
            ...
            $_edit_$() {
                ...
                this.$_file2_$ = JSON.parse(this.$_Form_$.images);
                if(this.$_Form_$.files){
                    this.files = JSON.parse(this.$_Form_$.files);
                }else{
                    this.files = [];
                }
                if (this.$_file2_$.length > 0) {
                    for (let i = 0; i < this.$_file2_$.length; i++) {
                        this.$_file_$.push({
                            url: this.$_global_$.imgPath + this.$_file2_$[i],
                            response:{code:0,data:this.$_file2_$[i],message:""},
                        });
                    }
                }
                if (this.files.length > 0) {
                    for (let i = 0; i < this.files.length; i++) {
                        this.uploadList.push({
                            ...
                            url: this.baseUrl + this.files[i].filePath,
            ...
            vList() {
                this.$_sendQuery_$({
                    ...
                    data: {
                         "zoneId": this.$root.inparams.data.zoneId
                    },
