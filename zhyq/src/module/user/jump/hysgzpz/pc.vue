...
<template>
    <div>
        <div style="margin-left: 250px"><h2>会议室规则配置</h2></div>
        <br>
        <div title="会议室规则配置">
            ...
            <div slot="footer">
                <Button type="ghost" style="margin-left: 200px" @click="onBack">取 消</Button>
                <Button type="primary" style="margin-left: 50px" @click="$_saveEdit_$()">保 存</Button>
            </div>
        </div>
    </div>
</template>
